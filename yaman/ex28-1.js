...
console.log(textStr("JavaScript"));
//-----------------------------------------------------------------------------------------------------------------------
...
//   let seasonArr = ["January", "February", "March"];
//   let seasonArr1 = ["April", "May", "Jun"];
//   let seasonArr2 = ["July", "August", "September"];
//   let seasonArr3 = ["October", "November", "December"];
...
//   //   return resultSeason;
// }
// console.log(monthNames("hi my name is HAdi"));
//-----------------------------------------------------------------------------------------------------------------------------------
...
/////
// function degreesStudent(usreName, age, address, ...arags) {
//   let result = `hi this is ${userName}, and this ${age}, Berlin he live${address}`;
//   let sumAverage = result;
// }

// console.log(degreesStudent);
// degreesStudent(
//   "ahmad",
//   "20",
//   "Berlin marzhan",
